  ...
  return (
    <Layout>
      ...
      <section className="py-16 px-6 bg-gray-50 text-center">
        <h2 className="text-3xl font-bold mb-8">How QuickBite Works</h2>
      ...
      <section id="join" className="py-20 px-6 text-white bg-red-500 text-center">
        <h2 className="text-3xl font-bold mb-6">Partner With QuickBite</h2>
        <p className="max-w-xl mx-auto mb-8">
          Join our growing network of restaurants and delivery heroes. Reach thousands of hungry customers daily!
        </p>
        <div className="space-x-4">
          <button className="bg-white text-red-500 px-6 py-3 font-semibold rounded-full shadow-md hover:bg-gray-100">
            Join as Restaurant
          </button>
          <button className="bg-white text-red-500 px-6 py-3 font-semibold rounded-full shadow-md hover:bg-gray-100">
